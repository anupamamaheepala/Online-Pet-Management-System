...
//     contactNumber: '',
//     address: ''
//   }); // State to store edited customer data

//   useEffect(() => {
//     // Fetch customer data on component mount
//     const fetchCustomer = async () => {
//       try {
//         const response = await axios.get(`http://localhost:9000/customer/${match.params.id}`);
//         setCustomer(response.data);
//         setEditedCustomer(response.data); // Initialize editedCustomer state with fetched data
//       } catch (error) {
//         console.error(error);
//       }
//     };
